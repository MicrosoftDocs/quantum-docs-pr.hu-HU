...
- [<span data-ttu-id="2c853-107">.NET Core SDK 3.1 vagy újabb verzió</span><span class="sxs-lookup"><span data-stu-id="2c853-107">.NET Core SDK 3.1 or later</span></span>](https://www.microsoft.com/net/download)
...
1. <span data-ttu-id="2c853-113">Telepítse és töltse le a [VS Code-ot](https://code.visualstudio.com/download) (Windows, Linux és Mac).</span><span class="sxs-lookup"><span data-stu-id="2c853-113">Download and install [VS Code](https://code.visualstudio.com/download) (Windows, Linux and Mac).</span></span>
2. <span data-ttu-id="2c853-114">Telepítse a [VS Code-hoz készült Microsoft QDK-t](https://marketplace.visualstudio.com/items?itemName=quantum.quantum-devkit-vscode).</span><span class="sxs-lookup"><span data-stu-id="2c853-114">Install the [Microsoft QDK for VS Code](https://marketplace.visualstudio.com/items?itemName=quantum.quantum-devkit-vscode).</span></span>

### <a name="to-configure-for-visual-studio"></a><span data-ttu-id="2c853-115">Konfigurálás Visual Studióhoz:</span><span class="sxs-lookup"><span data-stu-id="2c853-115">To configure for Visual Studio:</span></span>

1. <span data-ttu-id="2c853-116">Töltse le és telepítse a [Visual Studio](https://visualstudio.microsoft.com/downloads/) 16.3-as vagy újabb verzióját, a .NET Core platformfüggetlen fejlesztési tevékenységprofil engedélyezésével.</span><span class="sxs-lookup"><span data-stu-id="2c853-116">Download and install [Visual Studio](https://visualstudio.microsoft.com/downloads/) 16.3 or greater, with the .NET Core cross-platform development workload enabled.</span></span>
2. <span data-ttu-id="2c853-117">Töltse le és telepítse a [Microsoft QDK-t](https://marketplace.visualstudio.com/items?itemName=quantum.DevKit).</span><span class="sxs-lookup"><span data-stu-id="2c853-117">Download and install the [Microsoft QDK](https://marketplace.visualstudio.com/items?itemName=quantum.DevKit).</span></span>

### <a name="to-configure-for-another-environment"></a><span data-ttu-id="2c853-118">Konfigurálás másik környezethez:</span><span class="sxs-lookup"><span data-stu-id="2c853-118">To configure for another environment:</span></span> 

1. <span data-ttu-id="2c853-119">Adja meg a következőt a parancssorban:</span><span class="sxs-lookup"><span data-stu-id="2c853-119">Enter the following at the command prompt</span></span>

```dotnetcli
dotnet new -i Microsoft.Quantum.ProjectTemplates
```

### <a name="to-configure-for-visual-studio-codespaces"></a><span data-ttu-id="2c853-120">Konfigurálás Visual Studio Codespaceshez:</span><span class="sxs-lookup"><span data-stu-id="2c853-120">To configure for Visual Studio Codespaces:</span></span>

1. <span data-ttu-id="2c853-121">Hozzon létre egy [Azure-fiókot](https://azure.microsoft.com/free/).</span><span class="sxs-lookup"><span data-stu-id="2c853-121">Create an [Azure account](https://azure.microsoft.com/free/).</span></span>
...
### <a name="vs-code"></a>[<span data-ttu-id="2c853-129">VS Code</span><span class="sxs-lookup"><span data-stu-id="2c853-129">VS Code</span></span>](#tab/tabid-vscode)
...
1. <span data-ttu-id="2c853-138">Kattintson a **Terminal (Terminál)**  -> **New Terminal (Új terminál)** elemre.</span><span class="sxs-lookup"><span data-stu-id="2c853-138">Click **Terminal** -> **New Terminal**.</span></span>
2. <span data-ttu-id="2c853-139">A terminál parancssorába írja be a következőt: `dotnet run`.</span><span class="sxs-lookup"><span data-stu-id="2c853-139">At the terminal prompt, enter `dotnet run`.</span></span>
...
1. <span data-ttu-id="2c853-152">Válassza a **Debug (Hibakeresés)**  -> **Start Without Debugging (Indítás hibakeresés nélkül)** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="2c853-152">Select **Debug** -> **Start Without Debugging**.</span></span>
2. <span data-ttu-id="2c853-153">Látni fogja, hogy a következő szöveg jelenik meg a konzolablakban: `Hello quantum world!`.</span><span class="sxs-lookup"><span data-stu-id="2c853-153">You should see the text `Hello quantum world!` printed to a console window.</span></span>

> [!NOTE]
> <span data-ttu-id="2c853-154">Ha egy Visual Studio-megoldásban több projekt is található, a megoldásban foglalt összes projektnek a megoldás mappájában vagy valamelyik almappájában kell lennie.</span><span class="sxs-lookup"><span data-stu-id="2c853-154">If you have multiple projects within one Visual Studio solution, all projects contained in the solution need to be in the same folder as the solution, or in one of its sub-folders.</span></span>  
...
1. <span data-ttu-id="2c853-162">A következő szövegnek kell megjelennie: `Hello quantum world!`</span><span class="sxs-lookup"><span data-stu-id="2c853-162">You should see the following text printed: `Hello quantum world!`</span></span>

***

## <a name="next-steps"></a><span data-ttu-id="2c853-163">További lépések</span><span class="sxs-lookup"><span data-stu-id="2c853-163">Next steps</span></span>

<span data-ttu-id="2c853-164">Most, hogy a választott környezetben telepítette a Quantum Development Kitet, megírhatja és futtathatja [az első kvantumprogramját](xref:microsoft.quantum.quickstarts.qrng).</span><span class="sxs-lookup"><span data-stu-id="2c853-164">Now that you have installed the Quantum Development Kit in your preferred environment, you can write and run [your first quantum program](xref:microsoft.quantum.quickstarts.qrng).</span></span>
