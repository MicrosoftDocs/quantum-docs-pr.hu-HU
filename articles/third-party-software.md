...
## <a name="xunitrunnervisualstudio-notices-and-information"></a>xUnit. Runner. VisualStudio kapcsolatos megjegyzések és információk
---------------------------------------
Copyright (c) .NET Foundation és közreműködők minden jog fenntartva

Az Apache licenc alatt, a 2,0-es verzióban licenccel rendelkezik (a "licenc"); ezt a fájlt nem használhatja, kivéve a licenccel való megfelelőséget.
A licenc másolatát a következő helyen szerezheti be:

 [http://www.apache.org/licenses/LICENSE-2.0](http://www.apache.org/licenses/LICENSE-2.0)

Hacsak a vonatkozó jogszabályok nem igénylik, vagy írásban nem fogadják el, a licenc keretében terjesztett szoftvereket "adott állapotban" osztják el, semmilyen kifejezett vagy vélelmezett szavatosság nélkül.
Tekintse meg a licencet, amely az adott nyelvre vonatkozó engedélyeket és korlátozásokat szabályozza.



## <a name="xunitrunnerconsole-notices-and-information"></a>xUnit. Runner. Console – megjegyzések és információk
---------------------------------------
Copyright (c) .NET Foundation és közreműködők minden jog fenntartva
...
## <a name="xunitextensibilitycore-notices-and-information"></a>xUnit. bővíthetőség. alapvető megjegyzések és információk
---------------------------------------
Copyright (c) .NET Foundation és közreműködők minden jog fenntartva
...
## <a name="xunitcore-notices-and-information"></a>xUnit. Core-megjegyzések és információk
---------------------------------------
Copyright (c) .NET Foundation és közreműködők minden jog fenntartva
...
## <a name="xunitassert-notices-and-information"></a>xUnit. állítással kapcsolatos megjegyzések és információk
---------------------------------------
Copyright (c) .NET Foundation és közreműködők minden jog fenntartva
...
## <a name="xunitanalyzers-notices-and-information"></a>xUnit.-elemzői megjegyzések és információk
---------------------------------------
Copyright (c) .NET Foundation és közreműködők minden jog fenntartva
...
## <a name="xunitabstractions-notices-and-information"></a>xUnit. absztrakciós megjegyzések és információk
---------------------------------------
Copyright (c) .NET Foundation és közreműködők minden jog fenntartva
...
## <a name="xunit-notices-and-information"></a>xUnit kapcsolatos megjegyzések és információk
---------------------------------------
Copyright (c) .NET Foundation és közreműködők minden jog fenntartva
...
## <a name="managedesent-notices-and-information"></a>ManagedEsent kapcsolatos megjegyzések és információk
---------------------------------------
Microsoft nyilvános licenc (MS-PL)
...
A "hozzájárulás" az eredeti szoftver, illetve a szoftver kiegészítései vagy módosításai.

A "közreműködő" bármely személy, aki a licenc keretében osztja el a hozzá tartozó részt.

A "licencelt szabadalmak" olyan közreműködő szabadalmi jogcímek, amelyek közvetlenül a saját hozzájárulásán keresztül olvashatók be.
...
(A) nem rendelkezik védjegy-licenccel – ez a licenc nem biztosít Önnek jogosultságot a közreműködők nevének, emblémájának vagy védjegyének használatához.

(B) Ha szabadalmi jogcímet hoz a szoftver által megsértett szabadalmakkal szemben, akkor az ilyen közreműködőtől a szoftverhez tartozó szabadalmi licenc automatikusan véget ér.

(C) Ha a szoftver bármely részét terjeszti, meg kell őriznie a szoftverben található szerzői jogi, szabadalmi, védjegy-és jóváírási megjegyzéseket.
...
## <a name="fsharpcharting-notices-and-information"></a>FSharp. diagramokkal kapcsolatos megjegyzések és információk
---------------------------------------
Az MIT licenc (MIT)
...
## <a name="fscheck-notices-and-information"></a>FsCheck kapcsolatos megjegyzések és információk
---------------------------------------
...
## <a name="fparsec-notices-and-information"></a>FParsec kapcsolatos megjegyzések és információk
---------------------------------------
