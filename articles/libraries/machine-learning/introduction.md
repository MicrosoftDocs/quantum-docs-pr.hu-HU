...
A besorolás egy felügyelt gépi tanulási feladat, amelyben a cél az, hogy az egyes adatmintákhoz tartozó címkéket $\{y_1, y_2, \ldots, y_d\}$. A "betanítási adatkészlet" a következő minták gyűjteménye: $ \mathcal{D} =\{(x, y)} $, ismert előre hozzárendelt címkékkel. Itt $x $ egy adatminta, és a $y $ a "betanítási címke" nevű ismert címkéje.
