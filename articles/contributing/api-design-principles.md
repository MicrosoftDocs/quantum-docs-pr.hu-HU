...
- ✅**Válassza ki** a műveletek és a függvények nevét, amelyek világosan közlik a meghívottak kívánt hatását, és nem annak megvalósítását. Vegye figyelembe, hogy a megvalósítást az API- [dokumentációs megjegyzésekben](xref:microsoft.quantum.guide.filestructure#documentation-comments)kell dokumentálni.
