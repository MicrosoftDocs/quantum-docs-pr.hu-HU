...
a \end{align} itt $ \\ {f, H \\ } $ nevűnek nevezzük a [Poisson-zárójelet](https://en.wikipedia.org/wiki/Poisson_bracket) , és a klasszikus dinamikában, a Dynamics meghatározásakor játszott központi szerepkör miatt mindenütt megjelenik.
...
Miután ezt megtette (és leegyszerűsíti az eredményt arra az esetre, amikor az egyik tiszta állapottal rendelkezik), a kvantum-állapothoz tartozó Schrödinger-egyenlet található \begin{align} i \ partial_t \ket{\psi (t)} = \hat{H} (t) \ket{\psi (t)}.
\end{align}
