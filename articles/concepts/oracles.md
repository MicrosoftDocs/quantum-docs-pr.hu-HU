...
A qubit-állapotokat a $ \ket{\vec{x}} = \ket{x_{0}} \otimes \ket{x_{1}} \otimes \cdots \otimes \ket{x_ {n-1}} $ címkével is címkézheti.
...
Tegyük fel például, hogy egy fázis orcale $O _f $ egy qubit függvényhez $f $.
