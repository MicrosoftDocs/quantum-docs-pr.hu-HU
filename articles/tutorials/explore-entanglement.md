...
> * <span data-ttu-id="0ad52-116">Bemutatja a kvantum-felakadás egy Q# program futtatásával szimulátorban.</span><span class="sxs-lookup"><span data-stu-id="0ad52-116">Demonstrate quantum entanglement with a Q# program run in a simulator.</span></span> 
...
<span data-ttu-id="0ad52-128">Most már készen áll annak bemutatására, hogy Q# ez hogyan fejezi ki ezt a viselkedést.</span><span class="sxs-lookup"><span data-stu-id="0ad52-128">Now, we're ready to demonstrate how Q# expresses this behavior.</span></span>  <span data-ttu-id="0ad52-129">A lehető legegyszerűbb programmal kezd, és azt építi fel a kvantum-szuperpozíció és a kvantum-összefonódás bemutatásához.</span><span class="sxs-lookup"><span data-stu-id="0ad52-129">You start with the simplest program possible and build it up to demonstrate quantum superposition and quantum entanglement.</span></span>

## <a name="creating-a-no-locq-project"></a><span data-ttu-id="0ad52-130">Projekt létrehozása Q#</span><span class="sxs-lookup"><span data-stu-id="0ad52-130">Creating a Q# project</span></span>

<span data-ttu-id="0ad52-131">Első lépésként hozzon létre egy új Q# projektet.</span><span class="sxs-lookup"><span data-stu-id="0ad52-131">The first thing we have to do is to create a new Q# project.</span></span> <span data-ttu-id="0ad52-132">Ebben az oktatóanyagban ezt a környezetet fogjuk használni a [ Q# vs Code-alkalmazások](xref:microsoft.quantum.install.standalone)alapján.</span><span class="sxs-lookup"><span data-stu-id="0ad52-132">In this tutorial we are going to use the environment based on [Q# applications with VS Code](xref:microsoft.quantum.install.standalone).</span></span>
...
1. <span data-ttu-id="0ad52-134">Kattintson a **View (Nézet)**  -> **Command Palette (Parancskatalógus)** elemre, és válassza a **Q#: Create New Project (Q#: Új projekt létrehozása)** lehetőséget.</span><span class="sxs-lookup"><span data-stu-id="0ad52-134">Click **View** -> **Command Palette** and select **Q#: Create New Project** .</span></span>
...
#### <a name="about-no-locq-operations"></a><span data-ttu-id="0ad52-157">Tudnivalók a Q# műveletekről</span><span class="sxs-lookup"><span data-stu-id="0ad52-157">About Q# operations</span></span>

<span data-ttu-id="0ad52-158">A Q# művelet egy kvantum-alrutin.</span><span class="sxs-lookup"><span data-stu-id="0ad52-158">A Q# operation is a quantum subroutine.</span></span> <span data-ttu-id="0ad52-159">Ez egy meghívásos rutin, amely más kvantum-műveletekre irányuló hívásokat is tartalmaz.</span><span class="sxs-lookup"><span data-stu-id="0ad52-159">That is, it is a callable routine that contains calls to other quantum operations.</span></span>
...
<span data-ttu-id="0ad52-224">Most nézzük meg, hogyan Q# fejezi ki a qubits-k összekeverhető módjait.</span><span class="sxs-lookup"><span data-stu-id="0ad52-224">Now let’s look at how Q# expresses ways to entangle qubits.</span></span>
