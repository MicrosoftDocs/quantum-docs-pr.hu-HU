...
### <a name="onresultzeroop--t--unit-adj--ctl"></a>onResultZeroOp: 'T => [egység](xref:microsoft.quantum.lang-ref.unit) , adj + CTL
...
### <a name="onresultoneop--u--unit-adj--ctl"></a>onResultOneOp: ' U => [egység](xref:microsoft.quantum.lang-ref.unit) – Adj + CTL
