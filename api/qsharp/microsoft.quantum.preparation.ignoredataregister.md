...
title: IgnoreDataRegister művelet
...
ms.locfileid: "98842413"
---
# <a name="ignoredataregister-operation"></a>IgnoreDataRegister művelet
...
### <a name="op--littleendianqubitqubit--unit--is-adj--ctl"></a>op: ([LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian),[Qubit](xref:microsoft.quantum.lang-ref.qubit)[],[Qubit](xref:microsoft.quantum.lang-ref.qubit)[]) => [egység](xref:microsoft.quantum.lang-ref.unit)  az Adj + CTL
