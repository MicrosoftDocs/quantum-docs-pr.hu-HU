...
---
# <a name="_applyjordanwignerclusteroperatorpqrsterm-operation"></a>_ApplyJordanWignerClusterOperatorPQRSTerm művelet
...
Alkalmazza az idő-Evolution műveletet egy, a PQRS által leírt kifejezéssel `GeneratorIndex` .
...
`GeneratorIndex` a cluster operátor PQRS kifejezése.
