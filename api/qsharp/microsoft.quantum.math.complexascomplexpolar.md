...
title: ComplexAsComplexPolar függvény
...
ms.locfileid: "98848867"
---
# <a name="complexascomplexpolar-function"></a>ComplexAsComplexPolar függvény
...
Komplex számú típust alakít át összetett típusúra `Complex` `ComplexPolar` .
...
## <a name="output--complexpolar"></a>Kimenet: [ComplexPolar](xref:Microsoft.Quantum.Math.ComplexPolar)
