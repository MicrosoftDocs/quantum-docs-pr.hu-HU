...
### <a name="statepreparation--qubit--unit-adj--ctl"></a>statePreparation: [Qubit](xref:microsoft.quantum.lang-ref.qubit)[] => [egység](xref:microsoft.quantum.lang-ref.unit) Adj + CTL

Egy egységes $P $, amely előkészíti a megcélzott állapotot.


### <a name="selector--qubitqubit--unit-adj--ctl"></a>választó: ([Qubit](xref:microsoft.quantum.lang-ref.qubit)[],[Qubit](xref:microsoft.quantum.lang-ref.qubit)[]) => [egység](xref:microsoft.quantum.lang-ref.unit) Adj + CTL
