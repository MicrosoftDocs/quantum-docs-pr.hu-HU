...
### <a name="trueop--t--unit-adj--ctl"></a>trueOp: 'T => [egység](xref:microsoft.quantum.lang-ref.unit) , adj + CTL
...
### <a name="falseop--u--unit-adj--ctl"></a>falseOp: ' U => [egység](xref:microsoft.quantum.lang-ref.unit) – Adj + CTL
