...
---
# <a name="applyifelseintrinsic-operation"></a>ApplyIfElseIntrinsic művelet
...
### <a name="onresultzeroop--unit--unit"></a>onResultZeroOp: [egység](xref:microsoft.quantum.lang-ref.unit) => [egység](xref:microsoft.quantum.lang-ref.unit) 




### <a name="onresultoneop--unit--unit"></a>onResultOneOp: [egység](xref:microsoft.quantum.lang-ref.unit) => [egység](xref:microsoft.quantum.lang-ref.unit) 
