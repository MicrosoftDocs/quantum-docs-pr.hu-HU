...
---
# <a name="_quantumromdiscretization-function"></a>_QuantumROMDiscretization függvény
...
## <a name="output--doubleintint"></a>Kimenet: ([Double](xref:microsoft.quantum.lang-ref.double),[int](xref:microsoft.quantum.lang-ref.int)[],[int](xref:microsoft.quantum.lang-ref.int)[])
