...
### <a name="onresultzeroop--t--unit-adj"></a>onResultZeroOp: 'T => [egység](xref:microsoft.quantum.lang-ref.unit) – Adj
...
### <a name="onresultoneop--u--unit-adj"></a>onResultOneOp: ' U => [egység](xref:microsoft.quantum.lang-ref.unit) Adj
