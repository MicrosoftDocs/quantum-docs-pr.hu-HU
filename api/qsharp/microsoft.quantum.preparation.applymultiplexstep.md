...
title: ApplyMultiplexStep művelet
...
ms.locfileid: "98854433"
---
# <a name="applymultiplexstep-operation"></a>ApplyMultiplexStep művelet
...
### <a name="disentangling--double"></a>szétválasztás: [Double](xref:microsoft.quantum.lang-ref.double)[]
