...
A két megadott szám közül a nagyobbat adja vissza.
...
További részletekért lásd: [System. Math. max](https://docs.microsoft.com/dotnet/api/system.math.max) .