...
---
# <a name="iristrainingdata-operation"></a>IrisTrainingData művelet

Névtér: [Microsoft. Quantum. MachineLearning. adatkészletek](xref:Microsoft.Quantum.MachineLearning.Datasets)
...
## <a name="output--labeledsample"></a>Kimenet: [LabeledSample](xref:Microsoft.Quantum.MachineLearning.LabeledSample)[]
