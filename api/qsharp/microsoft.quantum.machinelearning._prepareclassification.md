...
title: _PrepareClassification művelet
...
ms.locfileid: "98846127"
---
# <a name="_prepareclassification-operation"></a>_PrepareClassification művelet
...
### <a name="encoder--littleendian--unit--is-adj--ctl"></a>kódoló: az [LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian) => [egység](xref:microsoft.quantum.lang-ref.unit)  az Adj + CTL
